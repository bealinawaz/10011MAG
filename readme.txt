...
10011MAG is an elegant blog theme that features full-screen featured images.
...
10011MAG includes one optional widget area located behind the menu icon (three horizontal lines) in the header.

= How do I add the Social Links to the sidebar? =

10011MAG allows you display links to your social media profiles, like Twitter and Facebook, with icons.
